...
class Flocking(_data):
    ...
    def __init__(self, nAgents, commRadius, repelDist,
        ...
        initPosAll, initVelAll, validInit = self.computeInitialPositions(
    ...
    def computeInitialPositions(self, nAgents, nSamples, commRadius,
        ...
        for n in range(nSamples):
            if not graph.isConnected(graphMatrix[n,:,:]):
                validInit=False
        ...
        return initPos, initVel, validInit
